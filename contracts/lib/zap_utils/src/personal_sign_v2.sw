...
//NOTE - change the name back to personal_sign_hash() from personal_sign_hash_v2() once you have
//       removed the "v1" version from the codebase.
//
//      This is the 64 UTF-8 char version in v0.39.1 fuel-connectors
...
pub fn personal_sign_hash_v2(transaction_id: b256) -> b256 {
