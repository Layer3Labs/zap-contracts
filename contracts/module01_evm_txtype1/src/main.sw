...
fn main(
    ...
    let (
        tx_type_identifier,     // type_identifier (u64)
        tx_chain_id,            // chain_id (u64)
        tx_nonce,               // nonce (u64)
        tx_gas_price,           // gasPrice (u64)
        tx_gas_limit,           // gasLimit (u64)
        tx_value_wei,           // value as wei (u256)
        tx_to,                  // receiver address (b256)
        tx_asset_id,            // asset_id (b256)
        tx_digest,              // rlp tx digest (b256)
        tx_lengeth,             // rlp tx length (u64)
        tx_data_start,          // tx_data_start (u64)
        tx_data_end,            // tx_data_end (u64)
        tx_signature,           // rlp tx signature (B512)
        tx_from                 // recovered signer address (b256)
